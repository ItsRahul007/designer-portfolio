  ...
  return (
    <section className="h-[210px] w-full bg-[#151638] flex justify-evenly items-center divide-x">
      {listItems.map(({ icon, text }) => (
        <div
          key={text}
          className="border-gray-600 h-full w-full flex flex-col gap-2 justify-center items-center text-white hover:text-btnHover duration-300 text-3xl hover:bg-[rgba(255,255,255,0.03)] group"
        >
